...
<body>
    ...
    */
    $list = array(
        array("ID" => "001", "Name" => "Keyboard Logitek", "Price" => 600000, "Description" => "Keyboard yang mantap untuk kantoran", "Source" => "Logitec.jpg"),
        array("ID" => "002", "Name" => "Keyboard MSI", "Price" => 300000, "Description" => "Keyboard gaming MSI mekanik", "Source" => "msi.jpg"),
        array("ID" => "003", "Name" => "Mouse Genius", "Price" => 30000, "Description" => "Mouse Genius biar lebih pinter", "Source" => "mousejenius.jpg"),
        array("ID" => "004", "Name" => "Mouse Logitec", "Price" => 50000, "Description" => "Mouse yang disukai kucing", "Source" => "mouselogitec.jpg"),
    );
    echo "<pre>";
    print_r($list);
    echo "</pre>";
